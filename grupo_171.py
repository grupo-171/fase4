...
# ---------------- SIMULACIÓN ----------------
def simulacion():
    falta crear clase de sistemaFJ 
    ...
    try:
        ...
        except Cliente as einvalido as e:
            logging.error(e)
